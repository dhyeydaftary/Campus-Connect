    ...
    toast.innerHTML = `
        <div class="p-4 relative">
            ...
            <div class="absolute bottom-0 left-0 right-0 h-1 bg-gray-100">
                <div class="progress-bar h-full ${type === 'success' ? 'bg-green-400' : type === 'error' ? 'bg-red-400' : type === 'warning' ? 'bg-yellow-400' : 'bg-blue-400'}" style="animation: progress ${duration / 1000}s linear forwards;"></div>
            </div>
        </div>
    `;
